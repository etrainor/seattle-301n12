...
function displayPics(){
  ...
  // The console.log(rando) threw an error because changing the var to const made rando only locally accessible from within the while loop instead of within the displayPics function. The console.log is outside the while loop so can't access rando.
  console.log(viewed);
